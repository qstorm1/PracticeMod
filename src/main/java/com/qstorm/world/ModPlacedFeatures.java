...
//tells how to place thing in world
public class ModPlacedFeatures {
    //Biomes modification is a class that defines which biome is it going to be placed
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name){
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(PracticeMod.MOD_ID,name));
    }
